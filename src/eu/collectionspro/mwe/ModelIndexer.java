...
public class ModelIndexer extends BaseModelWalker {
	...
	public void finish() {
		...
		List<Map.Entry<EClass,Integer> > list = new ArrayList<Map.Entry<EClass,Integer> >(perMetaClass.entrySet());
		Collections.sort(list, new Comparator<Map.Entry<EClass,Integer> >() {
			@Override
			public int compare(Entry<EClass, Integer> arg0,
					Entry<EClass, Integer> arg1) {
